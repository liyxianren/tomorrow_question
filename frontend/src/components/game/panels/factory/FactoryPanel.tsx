                  ...
                  return (
                    ...
                    >
                      <div className="factory-command-row__main">
                        ...
                        <p>{isLocked ? `${t("common:decision.lockedBy", { reason: action.lockedReason })}` : action.description}</p>
...
export function getConstructionTitle(
  ...
  if (kind === "expansion") {
    return i18n.t("game:factory.expandAction", { label: option.routeLabel });
  }
  if (kind === "upgrade") {
    return i18n.t("game:factory.upgradeAction", { label: option.routeLabel });
  }
  return i18n.t("game:factory.newFactoryAction", { label: option.routeLabel });
}
