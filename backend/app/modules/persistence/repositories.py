...
def _normalize_snapshot_payload(payload: dict[str, Any]) -> GameSnapshotPayload:
    ...
    for player_id, player_state in payload["nationalStateByPlayer"].items():
        national_state_by_player[str(player_id)] = {
            ...
            "armyCap": int(player_state.get("armyCap", 3)),
            ...
            "activeResearch": player_state.get("activeResearch"),
            "researchProgress": dict(player_state.get("researchProgress", {})),
            "breakthroughAttempts": dict(player_state.get("breakthroughAttempts", {})),
