...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "final_replay_loser_2": "Once market revenue falls behind, check whether demand, routes, or administrative support are slowing the operating rhythm.",
        ...
        "final_log_title_naval": "Route Control Changed",
    ...
    "zh": {
        ...
        "final_replay_loser_2": "一旦市场回款开始落后，优先检查是不是内需、航线或行政支撑拖慢了经营节奏。",
